        ...
        >
          <div className="flex items-center h-full w-full justify-center">
            <label
              ...
              className="flex flex-col w-full h-full rounded-lg items-center justify-center bg-gray-50 cursor-pointer hover:bg-gray-100"
            >
  ...
  return (
    ...
    >
      <DialogTrigger onClick={() => setIsOpen(true)} asChild>
        <Button>
          Upload PDF{" "}
          <UploadCloudIcon className="h-5 w-5 ml-4 text-white animate-bounce" />
        </Button>
      </DialogTrigger>
      <DialogContent>
        <UploadDropZone />
